...
- Small, self-contained mechanical tasks in either frontend or backend: use agent "sonic". Settings route it to GPT-5.6 Luna max. Use Sonic only when the slice requires no new design decision, business-rule interpretation, or broad integration and can be completed by one worker.
